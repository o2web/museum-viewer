...
@if $create-font-face == true{
	@font-face {
	 ...
	 src: url('__RELATIVE_FONT_PATH__/__FAMILY__.woff') format('woff'); /* Pretty Modern Browsers */
	 src: url('__RELATIVE_FONT_PATH__/__FAMILY__.ttf') format('truetype'); /* Safari, Android, iOS */
	 src: url('__RELATIVE_FONT_PATH__/__FAMILY__.svg') format('svg'); /* Legacy iOS */
	}
}
